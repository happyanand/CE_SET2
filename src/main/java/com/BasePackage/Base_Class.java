...
public class Base_Class {
	...
	public void SetUpRegressionForCTI(String ReferenceLogin) throws IOException, InterruptedException {
		...
		} else if (Url.contains("https://ce-uat.benefitalign.com/"))
		{
			...
			ExtentSuccessMessage("Logged in Environment: QA");
			System.out.println("Logged in Environment: QA");
		} else if (Url.contains("https://mme.benefitalign.com/mme/#/login")) {
			ExtentSuccessMessage("Logged in Environment: PR");
			System.out.println("Logged in Environment: PR");
		}else {
			ExtentSuccessMessage("Logged in Environment: Dev");
		}
		String UserName = null;
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("AWSPPAdminUserName1")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("AWSPPAdminPassword1")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://ce-qa.benefitalign.com/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("QAAdminUserName1")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("QAAdminPassword1")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://mme.benefitalign.com/mme/#/login")) {

				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("PRUserName1")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("PRPassword1")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
	...
	public void SetUpCEUserfiveCognito(String ReferenceLogin) throws IOException, InterruptedException {
		...
		for (String key : configloader().stringPropertyNames()) {
			String value = configloader().getProperty(key);
			if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/mme/")) {
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://ce-qa.benefitalign.com/#/login")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("QAAdminUserName1")) {
					UserName = replaceKeyValue;
			...
			else if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/mme/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("AWSPPAdminUserName1")) {
					UserName = replaceKeyValue;
		...
		case "CHROME":
			...
			options.addArguments("use-fake-ui-for-media-stream");
			// Instantiate ChromeDriver
			//options.addArguments("--window-size=1920x1080");  // Set the window size manually
		...
		System.out.println("newsize width:- "+newsize.getWidth());
		System.out.println("newsize Height:- "+newsize.getHeight());
		// click(AcceptCookies);
		Pagetitle = driver.getTitle();
		ExtentSuccessMessage("Title is displayed : " + Pagetitle);
	...
	public void SetUpCEUserfiveHeadless(String ReferenceLogin) throws IOException, InterruptedException {
     ...
     if (jenkinsUrl != null && !jenkinsUrl.isEmpty()) {
        ...
        if (Url.contains("https://truecoverage-pp.brokerengage.net/")) {
            ExtentSuccessMessage("Logged in Environment: AWSPP");
            System.out.println("Logged in Environment: AWSPP");
        } 
        else if (Url.contains("https://truecoverage-uat.benefitalign.com/"))
        {
            ...
            ExtentSuccessMessage("Logged in Environment:SSO QA");
            System.out.println("Logged in Environment: SSO QA");
        } else if
        	  (Url.contains("ce-qa.benefitalign.com/mme")) {
                ExtentSuccessMessage("Logged in Environment: QA");
                System.out.println("Logged in Environment :QA");
                ExtentSuccessMessage("Logged in Environment: QA");
        }
        ...
        else if  (Url.contains("https://ce-uat.benefitalign.com/mme")) {
            ExtentSuccessMessage("Logged in Environment: UAT");
            System.out.println("Logged in Environment: UAT");}
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && Url.contains("ce-qa.benefitalign.com/mme/#/login")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
			...
			else if (key.contains(ReferenceLogin) && Url.contains("https://truecoverage-uat.benefitalign.com/mme/")) {
                String KeyValue = key + ";" + value;
                String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
                if (replaceKeyValue.contains("UserNameSSOUAT")) {
                       UserName = replaceKeyValue;
			...
			else if (key.contains(ReferenceLogin) && Url.contains("https://mme.benefitalign.com/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("UserNamePR")) {
					UserName = replaceKeyValue;
			...
			else if (key.contains(ReferenceLogin) && Url.contains("https://truecoverage-pp.brokerengage.net/mme/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("UserNameSSOPP")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("PasswordSSOPP")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
        ...
        case "CHROME":
        	...
        	options.addArguments("--force-device-scale-factor=0.60"); // Zoom out to 75%
        	driver = new ChromeDriver(options);
        	ExtentSuccessMessage("Launched brower is : Chrome");
        	break;
        ...
        Pagetitle = driver.getTitle();
        ExtentSuccessMessage("Title is displayed : " + Pagetitle);
        if(Url.contains("https://truecoverage-qa.benefitalign.com/mme/") || Url.contains("https://truecoverage-uat.benefitalign.com/") || Url.contains("https://truecoverage-pp.brokerengage.net/"))
        {
            input(SSO_userId, UserName);
               click(SSO_next);
               input(SSO_Password, Password);
...
//		js.executeScript("window.resizeTo(1920, 1080);");
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("document.documentElement.style.height = '1080px';");
		js.executeScript("document.documentElement.style.width = '1920px';");

	}

	//These is base class for SSO qa
	public void SetUpRegressionForCTISSO(String ReferenceLogin) throws IOException, InterruptedException {
		...
		if (Url.contains("https://mme.brokerengage.net/")) {
			...
			ExtentSuccessMessage("Logged in Environment:SSO UAT");
			System.out.println("Logged in Environment:SSO UAT");
		}else if (Url.contains("https://ce-qa.benefitalign.com/#/login"))	{
			ExtentSuccessMessage("Logged in Environment: QA");
			System.out.println("Logged in Environment: QA");
		} else if (Url.contains("https://mme.brokerengage.net/mme/"))	{
			ExtentSuccessMessage("Logged in Environment: COGNITO");
			System.out.println("Logged in Environment: COGNITO");
		}else	{
			ExtentSuccessMessage("Logged in Environment: DEV");
		}
	...
	public void Loginuser_1 (String ReferenceLogin) throws IOException, InterruptedException {
		String Browser = configloader().getProperty("Browser");
		String Url = configloader().getProperty("URL");
		String jenkinsBrowser = System.getProperty("BROWSER");
		if (jenkinsBrowser != null && !jenkinsBrowser.isEmpty()) {
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("AWSPPAdminUserNameR")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("AWSPPAdminPasswordR")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
			...
			if (key.contains(ReferenceLogin) && Url.contains("https://ce-qa.benefitalign.com/")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("QAAdminUserNameR")) {
					UserName = replaceKeyValue;
					String[] arrOfUserName = UserName.split(";");
					UserName = arrOfUserName[1];
				}
				if (replaceKeyValue.contains("QAAdminPasswordR")) {
					Password = replaceKeyValue;
					String[] arrOfPassword = Password.split(";");
					Password = arrOfPassword[1];
				}
	...
	public void Loginuser_1SSO(String ReferenceLogin) throws IOException, InterruptedException {
		...
		for (String key : configloader().stringPropertyNames()) {
			...
			else if (key.contains(ReferenceLogin) && Url.contains("https://mme.brokerengage.net/mme/#/login")) {
				String KeyValue = key + ";" + value;
				String replaceKeyValue = KeyValue.replace(ReferenceLogin + "_", "");
				if (replaceKeyValue.contains("AWSPPAdminUserName1")) {
					UserName = replaceKeyValue;
	...
	public static void RobotKeyOperation(String strKey) throws AWTException, InterruptedException {
		try {
			...
			case "A":
				...
				ExtentSuccessMessage("Successfully click on 'A' Key");
				break;
			}
	...
	public static void UploadFileWithRobot(String filePath, By fileUploadButton)
	...
	public static int CheckValuePresentUnderWebTableRow(String TableId, String CheckForValue)throws InterruptedException {
