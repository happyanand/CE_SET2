...
public class AG_TS_008_TC_001_002_Filter_Validations extends AllScenarios_EG_TC {
	...
	public void Agent_Filter_Validations(CensusInfo ApplicantInfo)	throws ClassNotFoundException, Exception {
		...
		System.out.println("******* AG_TS_008_TC_001_002_Filter_Validations ***************");		  
		consumerpage.login_CE_validations();
		Agent_Validations.ClickOnMinimizeCallwindow();
//		Agent_Validations.agency_CreateAgent(ApplicantInfo);
		Agent_Validations.Filter_Validations();
		Agent_Validations.Apply_Filter();;
