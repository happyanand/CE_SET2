...
public class CM_TS_001_TC_001_validate_user_can_set_criteria_commission_rate extends AllScenarios_EG_TC {
	...
	public void CE_TC_Commission_validate_user_can_set_criteria_commission_rate(CensusInfo ApplicantInfo)	throws ClassNotFoundException, Exception {
		...
		System.out.println("******* Customer Engage Login Logout Validation CM_TS_001_TC_001_validate_user_can_set_criteria_commission_rate ***************");		  
		consumerpage.login_CE_validations();
		Commission_Page.validate_user_can_set_criteria_commission_rate();
